...
const Layout = (props) => {
    ...
    return (
        <React.Fragment>
            <Head>
                <title>Global R2Northstar Stats</title>
                <meta charSet="UTF-8" />
                <meta name="description" content="A website for viewing global stats for R2Northstar" />
                <meta name="robots" content="index, follow" />
                <meta name="viewport" content="initial-scale=1, width=device-width" />
                <meta property="og:type" content="website"></meta>
                <meta property="og:title" content="Global R2Northstar Stats"></meta>
                <meta property="og:description" content="A website for viewing global stats for R2Northstar" />
